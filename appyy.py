...
<div class="app-header">
    ...
    <p style="font-size: 1.3rem; color: #655;">Ask an intelligent agent questions about your specific documents.</p>
</div>
""", unsafe_allow_html=True)
...
if prompt := st.chat_input("Ask a question about the uploaded documents..."):
    ...
    if not os.path.exists(CHROMA_DB_DIR):
        st.warning(f"⚠️ Vector store not found  Please upload documents and click ' Vector Store' in the sidebar first.")
    else:
